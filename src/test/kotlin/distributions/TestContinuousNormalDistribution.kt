...
class TestContinuousNormalDistribution {
    ...
    fun testChanceBetween() {
        ...
        assertEquals(0.9512, standard.chanceBetween(-2.34, 1.76), 0.0001)
        assertEquals(1.0, standard.chanceBetween(), 0.0001)

        val custom1 = ContinuousNormalDistribution(10.0, 2.0)
        assertEquals(0.9332, custom1.chanceBetween(upperBound = 13.0), 0.0001)
        assertEquals(0.6915, custom1.chanceBetween(lowerBound = 9.0), 0.0001)
        assertEquals(0.1587, custom1.chanceBetween(-2.0, 8.0), 0.0001)
